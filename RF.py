...
metrics_df.to_excel("C:/Users/user/Desktop/walk_forward_RF_metrics_with_featuresVAL.xlsx", index=False)

testmetrics_df = pd.DataFrame(testmetric_results)
testmetrics_df.to_excel("C:/Users/user/Desktop/walk_forward_RF_metrics_with_featuresTEST.xlsx", index=False)
